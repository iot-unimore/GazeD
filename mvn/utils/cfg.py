...
config.dataset.train_shards = 'data-{000000..000000}.tar'
config.dataset.val_shards = 'data-{000000..000000}.tar'
config.dataset.test_shards = 'data-{000000..000000}.tar'


config.gaze = edict()
config.gaze.num_joints = 18
config.gaze.leye = 1
config.gaze.reye = 2
config.gaze.root_joint = 17
