...
class GazeTransformer(ModelMixin, nn.Module):
    def __init__(self, config=None, num_frame=1, num_joints=17, num_queries = 20, in_chans=2, 
        ...
        self.project_objects = nn.Linear(256 ,embed_dim)

        self.object_blocks = nn.MultiheadAttention(embed_dim,num_heads=8)
    ...
    def forward(self, keypoints_2d, ref, features_list, objects, eye_midpoint):
